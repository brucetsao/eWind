...
void loop() {
  ...
  digitalWrite(RSLED,LOW) ;
   connectstr = "" ;
   //http://weather.wtes.tc.edu.tw/wind/windadd.php?mac=AABBCCDDEEFF&ip=192.168.88.122&speed=2.2&way=0&waydir=0&temp=25&humid=67
   //http://192.168.88.88:8886//wind/windadd.php?mac=AABBCCDDEEFF&ip=192.168.88.122&speed=2.2&way=0&waydir=0&temp=25&humid=67
